...
if($stmt)
{
    $user_session->message("Mail has been updated successfully");
...
<?php echo Notification::display_message()?> </h5>
				...
				<form name="registration" id="updatemail" action="<?php echo Path::url_for('change-emaild.php');?>" method="post">
<div class="form-group">
									<label for="fess">
																 User Email
															</label>
			<input type="email" class="form-control" name="email" id="email" onBlur="userAvailability()"  placeholder="Email" value="<?php echo $patient->email;?>" required>
