...
if(Path::is_post_request()){
    ...
    $bk = new BookAppointment($specilization, $doctorid, $userid, $fees,$appdate,$time,$userstatus, $docstatus);
    $result = $bk->create();
    if ($result){
        Notification::message('Your appointment was successfully booked');
        Path::redirect_to(Path::url_for('book-appointment.php'));
    }else{
					...
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<?php echo Error::customized_display_error($error);?></p>
